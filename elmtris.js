		...
		_elm_lang$core$Array$fromList(
			A2(
				...
				A2(
					...
					A2(_elm_lang$core$Array$repeat, _ditrytus$elmtris$Board$columns, false)),
				remainingRows)));
};
			...
			F3(
				function (row, col, cell) {
					return A2(
						...
						cell,
						A3(_ditrytus$elmtris$Brick$isAt, row - brick.brickPos.y, col - brick.brickPos.x, brick));
				}),
			board);
	});
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _ditrytus$elmtris$Main$main === 'undefined' ? null : _ditrytus$elmtris$Main$main);
