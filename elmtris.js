...
var _user$project$Main$flattenArray2D = function (array2D) {
...
var _user$project$Main$hasValue = function (maybe) {
	var _p0 = maybe;
	if (_p0.ctor === 'Just') {
		return true;
	} else {
...
var _user$project$Main$cellHeight = 10;
var _user$project$Main$cellWidth = 10;
var _user$project$Main$viewBoard = function (board) {
					...
					A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Basics$toString(column * _user$project$Main$cellWidth)),
								_elm_lang$svg$Svg_Attributes$y(
								_elm_lang$core$Basics$toString(row * _user$project$Main$cellHeight)),
								_elm_lang$svg$Svg_Attributes$width(
								_elm_lang$core$Basics$toString(_user$project$Main$cellWidth + 0.1)),
								_elm_lang$svg$Svg_Attributes$height(
								_elm_lang$core$Basics$toString(_user$project$Main$cellHeight + 0.1)),
	...
	return A2(
		...
		_elm_lang$core$Array$toList(
			_user$project$Main$flattenArray2D(
				A2(_tortus$elm_array_2d$Array2D$indexedMap, cellToRect, board))));
};
var _user$project$Main$updatePosition = F2(
	function (changePosFunc, brick) {
		return _elm_lang$core$Native_Utils.update(
			brick,
			{
				brickPos: changePosFunc(brick)
			});
	});
var _user$project$Main$toRight = function (brick) {
	var pos = brick.brickPos;
	return _elm_lang$core$Native_Utils.update(
		pos,
		{x: pos.x + 1});
};
var _user$project$Main$toLeft = function (_p2) {
	var _p3 = _p2;
	var _p4 = _p3.brickPos;
	return _elm_lang$core$Native_Utils.update(
		_p4,
		{x: _p4.x - 1});
};
var _user$project$Main$down = function (_p5) {
	var _p6 = _p5;
	var _p7 = _p6.brickPos;
	return _elm_lang$core$Native_Utils.update(
		_p7,
		{y: _p7.y + 1});
};
var _user$project$Main$moveBrick = F3(
	function (moveFunc, collisionFunc, state) {
		var brick = state.brick;
		var newBrick = moveFunc(brick);
		return A2(collisionFunc, newBrick, state.board) ? _elm_lang$core$Maybe$Nothing : _elm_lang$core$Maybe$Just(
			_elm_lang$core$Native_Utils.update(
				state,
				{brick: newBrick}));
	});
var _user$project$Main$brickOriginX = function (brick) {
	return brick.brickPos.x;
};
var _user$project$Main$updateGameState = F2(
	function (updateStateFunc, model) {
		var _p8 = model;
		if (_p8.ctor === 'Gameplay') {
			return updateStateFunc(_p8._0);
		} else {
			return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
		}
	});
var _user$project$Main$brickShape = function (_p9) {
	var _p10 = _p9;
	var _p18 = _p10.rot;
	var _p11 = _p10.bType;
	switch (_p11.ctor) {
...
var _user$project$Main$brickHeight = function (_p19) {
	return _tortus$elm_array_2d$Array2D$rows(
		_user$project$Main$brickShape(_p19));
};
var _user$project$Main$brickOriginY = function (brick) {
	return brick.brickPos.y - _user$project$Main$brickHeight(brick);
};
var _user$project$Main$brickWidth = function (_p20) {
	return _tortus$elm_array_2d$Array2D$columns(
		_user$project$Main$brickShape(_p20));
};
var _user$project$Main$isBrickAt = F3(
	function (row, col, brick) {
		return A2(
			...
			A3(
				...
				row - _user$project$Main$brickOriginY(brick),
				col - _user$project$Main$brickOriginX(brick),
				_user$project$Main$brickShape(brick)));
	});
var _user$project$Main$isBrickOnOtherBrick = F2(
						...
						F3(
							function (row, col, cell) {
								return A2(
									...
									cell,
									A3(_user$project$Main$isBrickAt, row, col, brick));
							}),
						board))));
	});
var _user$project$Main$mergeElements = F2(
	function (brick, board) {
		return A2(
			_tortus$elm_array_2d$Array2D$indexedMap,
			F3(
...
var _user$project$Main$brickTypesCount = 7;
var _user$project$Main$boardHeight = 20;
var _user$project$Main$isBrickOnGround = F2(
	function (brick, _p21) {
		return _elm_lang$core$Native_Utils.cmp(brick.brickPos.y, _user$project$Main$boardHeight) > 0;
	});
var _user$project$Main$displayHeight = _user$project$Main$cellHeight * _user$project$Main$boardHeight;
var _user$project$Main$boardWidth = 10;
var _user$project$Main$emptyBoard = A3(_tortus$elm_array_2d$Array2D$repeat, _user$project$Main$boardHeight, _user$project$Main$boardWidth, false);
var _user$project$Main$isBrickOnWall = F2(
	function (brick, _p22) {
		return (_elm_lang$core$Native_Utils.cmp(brick.brickPos.x, 0) < 0) || (_elm_lang$core$Native_Utils.cmp(
			brick.brickPos.x,
			_user$project$Main$boardWidth - _user$project$Main$brickWidth(brick)) > 0);
	});
var _user$project$Main$doesBrickCollide = F2(
	function (brick, board) {
		return A2(_user$project$Main$isBrickOnGround, brick, board) || (A2(_user$project$Main$isBrickOnOtherBrick, brick, board) || A2(_user$project$Main$isBrickOnWall, brick, board));
	});
var _user$project$Main$isBrickOnWallOrOtherBrick = F2(
	function (brick, board) {
		return A2(_user$project$Main$isBrickOnWall, brick, board) || A2(_user$project$Main$isBrickOnOtherBrick, brick, board);
	});
var _user$project$Main$removeLines = function (board) {
		...
		_elm_lang$core$Array$fromList(
			A2(
				...
				A2(
					...
					_user$project$Main$boardHeight - _elm_lang$core$List$length(remainingRows),
					A2(_elm_lang$core$Array$repeat, _user$project$Main$boardWidth, false)),
				remainingRows)));
};
var _user$project$Main$displayWidth = _user$project$Main$cellWidth * _user$project$Main$boardWidth;
var _user$project$Main$viewBoxSizes = A2(
	_elm_lang$core$Basics_ops['++'],
	'0 0 ',
	A2(
		_elm_lang$core$Basics_ops['++'],
		_elm_lang$core$Basics$toString(_user$project$Main$displayWidth),
		A2(
			_elm_lang$core$Basics_ops['++'],
			' ',
			_elm_lang$core$Basics$toString(_user$project$Main$displayHeight))));
var _user$project$Main$viewBorder = A2(
	_elm_lang$svg$Svg$rect,
	_elm_lang$core$Native_List.fromArray(
		[
			...
			_elm_lang$svg$Svg_Attributes$width(
			_elm_lang$core$Basics$toString(_user$project$Main$boardWidth * _user$project$Main$cellWidth)),
			_elm_lang$svg$Svg_Attributes$height(
			_elm_lang$core$Basics$toString(_user$project$Main$boardHeight * _user$project$Main$cellHeight)),
				...
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$svg$Svg_Attributes$fontSize('5px')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$svg$Svg$text('Press ANY key to start')
						]))
				]);
		case 'Gameplay':
			var _p24 = _p23._0;
			return _elm_lang$core$List$concat(
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$core$Native_List.fromArray(
						[_user$project$Main$viewBorder]),
						_user$project$Main$viewBoard(
						A2(_user$project$Main$mergeElements, _p24.brick, _p24.board))
					]));
		default:
			return _elm_lang$core$Native_List.fromArray(
				[]);
...
var _user$project$Main$view = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$svg$Svg_Attributes$viewBox(_user$project$Main$viewBoxSizes),
...
var _user$project$Main$Brick = F3(
	function (a, b, c) {
		return {bType: a, rot: b, brickPos: c};
	});
var _user$project$Main$GameState = F3(
	function (a, b, c) {
		return {brick: a, score: b, board: c};
	});
var _user$project$Main$TLike = {ctor: 'TLike'};
var _user$project$Main$LRight = {ctor: 'LRight'};
var _user$project$Main$LLeft = {ctor: 'LLeft'};
var _user$project$Main$ZRight = {ctor: 'ZRight'};
var _user$project$Main$ZLeft = {ctor: 'ZLeft'};
var _user$project$Main$Long = {ctor: 'Long'};
var _user$project$Main$Square = {ctor: 'Square'};
var _user$project$Main$intToBrickType = function (i) {
	var _p25 = i;
	switch (_p25) {
		case 1:
			return _user$project$Main$Square;
		case 2:
			return _user$project$Main$Long;
		case 3:
			return _user$project$Main$ZLeft;
		case 4:
			return _user$project$Main$ZRight;
		case 5:
			return _user$project$Main$LLeft;
		case 6:
			return _user$project$Main$LRight;
		default:
			return _user$project$Main$TLike;
	}
};
var _user$project$Main$commandWithRandomBrickType = function (cmd) {
	return A2(
		_elm_lang$core$Random$generate,
		cmd,
		A2(
			_elm_lang$core$Random$map,
			_user$project$Main$intToBrickType,
			A2(_elm_lang$core$Random$int, 1, _user$project$Main$brickTypesCount)));
};
var _user$project$Main$Horizontal = function (a) {
	return {ctor: 'Horizontal', _0: a};
};
var _user$project$Main$Vertical = function (a) {
	return {ctor: 'Vertical', _0: a};
};
var _user$project$Main$Deg270 = {ctor: 'Deg270'};
var _user$project$Main$Deg90 = {ctor: 'Deg90'};
var _user$project$Main$Deg180 = {ctor: 'Deg180'};
var _user$project$Main$Deg0 = {ctor: 'Deg0'};
var _user$project$Main$rotate = function (rot) {
	var _p26 = rot;
...
var _user$project$Main$updateRotation = function (brick) {
	return _elm_lang$core$Native_Utils.update(
		brick,
		{
			rot: _user$project$Main$rotate(brick.rot)
		});
};
var _user$project$Main$newBrick = function (brickType) {
	var angle = _user$project$Main$Horizontal(_user$project$Main$Deg0);
	var shape = {bType: brickType, rot: angle};
	return {
		bType: brickType,
		rot: angle,
		brickPos: A2(
			_user$project$Main$Pos,
			((_user$project$Main$boardWidth - _user$project$Main$brickWidth(shape)) / 2) | 0,
			_user$project$Main$brickHeight(shape))
	};
};
var _user$project$Main$GameOver = function (a) {
	return {ctor: 'GameOver', _0: a};
};
var _user$project$Main$Gameplay = function (a) {
	return {ctor: 'Gameplay', _0: a};
};
var _user$project$Main$toGameplayWith = F2(
	function (cmd, state) {
		return {
			ctor: '_Tuple2',
			_0: _user$project$Main$Gameplay(state),
			_1: cmd
		};
	});
var _user$project$Main$toGameplay = _user$project$Main$toGameplayWith(_elm_lang$core$Platform_Cmd$none);
...
var _user$project$Main$keyCodeToMove = function (keyCode) {
	var _p27 = keyCode;
	switch (_p27) {
		case 37:
			return _user$project$Main$Move(_user$project$Main$Left);
		case 38:
			return _user$project$Main$Move(_user$project$Main$Rotate);
		case 39:
			return _user$project$Main$Move(_user$project$Main$Right);
		case 40:
			return _user$project$Main$Move(_user$project$Main$Down);
		default:
			return _user$project$Main$Move(_user$project$Main$None);
	}
};
var _user$project$Main$Tick = {ctor: 'Tick'};
var _user$project$Main$NextBrick = function (a) {
	return {ctor: 'NextBrick', _0: a};
};
var _user$project$Main$FirstBrick = function (a) {
		...
		switch (_p28.ctor) {
			case 'Begin':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Main$commandWithRandomBrickType(_user$project$Main$FirstBrick)
				};
			case 'FirstBrick':
				return _user$project$Main$toGameplay(
					{
						brick: _user$project$Main$newBrick(_p28._0),
						score: 0,
						board: _user$project$Main$emptyBoard
					});
			case 'NextBrick':
				return A2(
					_user$project$Main$updateGameState,
					function (state) {
						return _user$project$Main$toGameplay(
							_elm_lang$core$Native_Utils.update(
								state,
				...
				switch (_p29.ctor) {
							...
							function (state) {
								return _user$project$Main$toGameplay(
									A2(
										...
										state,
										A3(
											_user$project$Main$moveBrick,
											_user$project$Main$updatePosition(_user$project$Main$toLeft),
											_user$project$Main$isBrickOnWallOrOtherBrick,
											state)));
							},
							model);
					case 'Right':
							...
							function (state) {
								return _user$project$Main$toGameplay(
									A2(
										...
										A3(
											_user$project$Main$moveBrick,
											_user$project$Main$updatePosition(_user$project$Main$toRight),
											_user$project$Main$isBrickOnWallOrOtherBrick,
											state)));
							},
							model);
					case 'Down':
						return A2(
							...
							function (state) {
								var _p30 = A3(
									_user$project$Main$moveBrick,
									_user$project$Main$updatePosition(_user$project$Main$down),
									_user$project$Main$doesBrickCollide,
									state);
								if (_p30.ctor === 'Just') {
									return _user$project$Main$toGameplay(_p30._0);
								} else {
									return A2(
										_user$project$Main$toGameplayWith,
										_user$project$Main$commandWithRandomBrickType(_user$project$Main$NextBrick),
										_elm_lang$core$Native_Utils.update(
											state,
											{
												board: _user$project$Main$removeLines(
													A2(_user$project$Main$mergeElements, state.brick, state.board))
											}));
								}
							},
							model);
					case 'Rotate':
						return A2(
							_user$project$Main$updateGameState,
							function (state) {
								var _p31 = A3(_user$project$Main$moveBrick, _user$project$Main$updateRotation, _user$project$Main$isBrickOnWallOrOtherBrick, state);
								if (_p31.ctor === 'Just') {
									return _user$project$Main$toGameplay(_p31._0);
								} else {
									return _user$project$Main$toGameplay(
										A2(
											_elm_lang$core$Maybe$withDefault,
											...
											A3(
												_user$project$Main$moveBrick,
												function (_p32) {
													return _user$project$Main$updateRotation(
														A2(_user$project$Main$updatePosition, _user$project$Main$toLeft, _p32));
												},
												_user$project$Main$isBrickOnWallOrOtherBrick,
												state)));
								}
			...
			return _elm_lang$core$Platform_Sub$batch(
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$keyboard$Keyboard$downs(_user$project$Main$keyCodeToMove)
					]));
		default:
			return _elm_lang$core$Platform_Sub$none;
	}
