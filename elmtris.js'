...
var _ditrytus$elmtris$Array2DExtras$flattenArray2D = function (array2D) {
		...
		switch (_p12.ctor) {
			case 'Deg0':
				...
				if (_p13.ctor === 'Clockwise') {
					return {
						ctor: '::',
						_0: A2(_ditrytus$elmtris$Brick$Pos, 0, 0),
						_1: {
							ctor: '::',
							_0: A2(_ditrytus$elmtris$Brick$Pos, -1, 0),
							_1: {
								ctor: '::',
								_0: A2(_ditrytus$elmtris$Brick$Pos, -1, 1),
								_1: {
									ctor: '::',
									_0: A2(_ditrytus$elmtris$Brick$Pos, 0, -2),
									_1: {
										ctor: '::',
										_0: A2(_ditrytus$elmtris$Brick$Pos, -1, -2),
										_1: {ctor: '[]'}
									}
								}
							}
			...
			case 'Deg0':
				...
				if (_p16.ctor === 'Clockwise') {
					return {
						...
						_1: {
							ctor: '::',
							_0: A2(_ditrytus$elmtris$Brick$Pos, -2, 0),
							_1: {
								ctor: '::',
								_0: A2(_ditrytus$elmtris$Brick$Pos, 1, 0),
								_1: {
									ctor: '::',
									_0: A2(_ditrytus$elmtris$Brick$Pos, -2, -1),
									_1: {
										ctor: '::',
										_0: A2(_ditrytus$elmtris$Brick$Pos, 1, 2),
										_1: {ctor: '[]'}
...
var _ditrytus$elmtris$Brick$allBrickTypes = {
	ctor: '::',
	_0: _ditrytus$elmtris$Brick$O,
	_1: {
		ctor: '::',
		_0: _ditrytus$elmtris$Brick$I,
		_1: {
			ctor: '::',
			_0: _ditrytus$elmtris$Brick$Z,
			_1: {
				ctor: '::',
				_0: _ditrytus$elmtris$Brick$S,
				_1: {
					ctor: '::',
					_0: _ditrytus$elmtris$Brick$J,
					_1: {
						ctor: '::',
						_0: _ditrytus$elmtris$Brick$L,
						_1: {
							ctor: '::',
							_0: _ditrytus$elmtris$Brick$T,
							_1: {ctor: '[]'}
						}
					}
				}
...
var _ditrytus$elmtris$Board$new = F2(
	function (r, c) {
		return A3(_tortus$elm_array_2d$Array2D$repeat, r, c, _elm_lang$core$Maybe$Nothing);
	});
var _ditrytus$elmtris$Board$cellToBool = function (cell) {
	var _p1 = cell;
	if (_p1.ctor === 'Just') {
		return true;
	} else {
		...
		A2(
			...
			function (row) {
				return A2(
					...
					A2(
						_elm_lang$core$List$map,
						_ditrytus$elmtris$Board$cellToBool,
		...
		_elm_lang$core$Array$fromList(
			A2(
				...
				A2(
					...
					_ditrytus$elmtris$Board$rows - _elm_lang$core$List$length(remainingRows),
					A2(_elm_lang$core$Array$repeat, _ditrytus$elmtris$Board$columns, _elm_lang$core$Maybe$Nothing)),
				remainingRows)));
};
...
var _ditrytus$elmtris$Model$Down = {ctor: 'Down'};
		...
		return A2(
			...
			F3(
				function (row, col, cell) {
					return A3(_ditrytus$elmtris$Brick$isAt, row - brick.brickPos.y, col - brick.brickPos.x, brick) ? _elm_lang$core$Maybe$Just(brick.bType) : cell;
				}),
			board);
	});
var _ditrytus$elmtris$Update$updatePosition = F2(
...
var _ditrytus$elmtris$Update$by = F2(
	function (t, brick) {
		var pos = brick.brickPos;
		return {x: pos.x + t.x, y: pos.y + t.y};
	});
var _ditrytus$elmtris$Update$toRight = _ditrytus$elmtris$Update$by(
	{x: 1, y: 0});
var _ditrytus$elmtris$Update$toLeft = _ditrytus$elmtris$Update$by(
	{x: -1, y: 0});
var _ditrytus$elmtris$Update$down = _ditrytus$elmtris$Update$by(
	{x: 0, y: 1});
var _ditrytus$elmtris$Update$doesCollide = F2(
	function (brick, board) {
		return A2(
			_elm_lang$core$List$any,
			_elm_lang$core$Basics$identity,
							...
							function (row, column, cell) {
								return A2(
									...
									_ditrytus$elmtris$Board$cellToBool(
										A2(
											_elm_lang$core$Maybe$withDefault,
											_elm_lang$core$Maybe$Just(_ditrytus$elmtris$Brick$O),
											A3(_tortus$elm_array_2d$Array2D$get, row + brick.brickPos.y, column + brick.brickPos.x, board))));
							}),
						_ditrytus$elmtris$Brick$shape(brick)))));
	});
...
var _ditrytus$elmtris$Update$updateRotation = F3(
	function (direction, state, brick) {
		var kicks = A3(_ditrytus$elmtris$Brick$wallKicks, brick.rot, direction, brick.bType);
		var rotatedBrick = _elm_lang$core$Native_Utils.update(
			brick,
			{
				rot: A2(_ditrytus$elmtris$Brick$rotate, direction, brick.rot)
			});
		return function (_) {
			return _.brick;
		}(
...
var _ditrytus$elmtris$Update$updateGameState = F2(
	function (updateStateFunc, model) {
		var _p0 = model;
		if (_p0.ctor === 'Gameplay') {
			return updateStateFunc(_p0._0);
		} else {
			return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
		}
	});
var _ditrytus$elmtris$Update$toGameplayWith = F2(
	function (cmd, state) {
		return {
			ctor: '_Tuple2',
			_0: _ditrytus$elmtris$Model$Gameplay(state),
			_1: cmd
		};
	});
...
var _ditrytus$elmtris$Update$levelUpEvery = 15;
			...
			case 'ToggleGhostBrick':
				...
				if (_p7.ctor === 'Gameplay') {
					...
					return _ditrytus$elmtris$Update$toGameplay(
						_elm_lang$core$Native_Utils.update(
							_p8,
							{ghostBrickEnabled: !_p8.ghostBrickEnabled}));
				} else {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
			default:
...
var _ditrytus$elmtris$Subscriptions$startNewGameOnKey = function (keyToStart) {
	return _elm_lang$keyboard$Keyboard$presses(
		function (keyCode) {
			return _elm_lang$core$Native_Utils.eq(keyCode, keyToStart) ? _ditrytus$elmtris$Model$Begin : _ditrytus$elmtris$Model$DoNothing;
		});
};
var _ditrytus$elmtris$Subscriptions$subscriptions = function (model) {
	var _p1 = model;
	switch (_p1.ctor) {
		case 'Start':
			return _ditrytus$elmtris$Subscriptions$startNewGameOnKey(115);
		case 'Gameplay':
			return _elm_lang$core$Platform_Sub$batch(
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$keyboard$Keyboard$downs(_ditrytus$elmtris$Subscriptions$keyCodeToMsg),
						_1: {ctor: '[]'}
					}
				});
		case 'Paused':
...
var _ditrytus$elmtris$View$cellToColor = function (brickType) {
	var _p0 = brickType;
	switch (_p0.ctor) {
		case 'O':
			return '#DAA520';
...
var _ditrytus$elmtris$View$appendInstructions = function (lines) {
	return _elm_lang$core$List$concat(
		{
			ctor: '::',
			_0: lines,
			_1: {
				ctor: '::',
				_0: _ditrytus$elmtris$View$instructions,
				_1: {ctor: '[]'}
			}
		});
};
...
var _ditrytus$elmtris$View$scaleSize = F2(
	function (_p1, size) {
		var _p2 = _p1;
		return {width: size.width * _p2._0, height: size.height * _p2._1};
	});
var _ditrytus$elmtris$View$scalePos = F2(
	function (_p3, pos) {
		var _p4 = _p3;
		return {x: pos.x * _p4._0, y: pos.y * _p4._1};
	});
...
var _ditrytus$elmtris$View$cellSize = A2(_ditrytus$elmtris$View$Size, 10, 10);
var _ditrytus$elmtris$View$boardSize = {
	width: _ditrytus$elmtris$View$cellSize.width * _elm_lang$core$Basics$toFloat(_ditrytus$elmtris$Board$columns),
		...
		F2(
			function (i, line) {
				return A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$svg$Svg$text(line),
						_1: {ctor: '[]'}
					});
			}),
		lines);
	...
	return {
		...
		_1: {
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$svg$Svg$text(box.label),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		}
...
var _ditrytus$elmtris$View$showNumberBox = F2(
	function (box, num) {
		...
		return _elm_lang$core$List$concat(
			{
				ctor: '::',
				_0: _ditrytus$elmtris$View$showLabeledBox(box),
				_1: {
					ctor: '::',
					_0: {
						ctor: '::',
					...
					return _elm_lang$core$Maybe$Just(
						A2(
							_elm_lang$svg$Svg$rect,
							{
								...
								_0: _elm_lang$svg$Svg_Attributes$x(
									_elm_lang$core$Basics$toString(
										_elm_lang$core$Basics$floor(pos.x) + (column * _elm_lang$core$Basics$floor(_ditrytus$elmtris$View$cellSize.width)))),
								_1: {
									ctor: '::',
									_0: _elm_lang$svg$Svg_Attributes$y(
										_elm_lang$core$Basics$toString(
											_elm_lang$core$Basics$floor(pos.y) + (row * _elm_lang$core$Basics$floor(_ditrytus$elmtris$View$cellSize.height)))),
									_1: {
										ctor: '::',
										_0: _elm_lang$svg$Svg_Attributes$width(
											_elm_lang$core$Basics$toString(_ditrytus$elmtris$View$cellSize.width + 0.1)),
										_1: {
											ctor: '::',
											_0: _elm_lang$svg$Svg_Attributes$height(
													...
													_0: _elm_lang$svg$Svg_Attributes$fill(
														function () {
															...
															if (_p6.ctor === 'Just') {
																...
																return _ditrytus$elmtris$View$cellToColor(_p5._0);
															}
														}()),
													_1: {ctor: '[]'}
												}
...
var _ditrytus$elmtris$View$showNextBrickBox = function (state) {
	return _elm_lang$core$List$concat(
		{
			ctor: '::',
			_0: _ditrytus$elmtris$View$showLabeledBox(_ditrytus$elmtris$View$nextBrickBox),
			_1: {
				ctor: '::',
				_0: function () {
	...
	return _elm_lang$core$List$concat(
		{
			...
			_0: {
				ctor: '::',
				_0: _ditrytus$elmtris$View$boardBorder,
				_1: {ctor: '[]'}
			},
			_1: {
				ctor: '::',
				...
				_1: {
					ctor: '::',
					_0: _ditrytus$elmtris$View$showLabeledBox(_ditrytus$elmtris$View$scoreBox),
					_1: {
						ctor: '::',
						_0: _ditrytus$elmtris$View$showLabeledBox(_ditrytus$elmtris$View$levelBox),
						_1: {
							ctor: '::',
							_0: _ditrytus$elmtris$View$showLabeledBox(_ditrytus$elmtris$View$linesBox),
							_1: {
								ctor: '::',
								_0: _ditrytus$elmtris$View$textInTheBoard(lines),
								_1: {ctor: '[]'}
							}
						}
					}
	...
	switch (_p8.ctor) {
		case 'Start':
			return _ditrytus$elmtris$View$boardWithText(
				_ditrytus$elmtris$View$appendInstructions(
					{
						ctor: '::',
						_0: 'Press S to start',
						_1: {ctor: '[]'}
					...
					_1: {
						...
						_0: A3(
							...
							A2(
								_ditrytus$elmtris$Board$skipRows,
								_ditrytus$elmtris$Board$obstructedRows,
								A2(_ditrytus$elmtris$Update$mergeWith, _p9.brick, _p9.board))),
						_1: {
							ctor: '::',
							_0: {
								ctor: '::',
							...
							_1: {
								ctor: '::',
								_0: _ditrytus$elmtris$View$showNextBrickBox(_p9),
								_1: {
									ctor: '::',
									_0: _ditrytus$elmtris$View$showPointsBox(_p9),
									_1: {
										ctor: '::',
										_0: _ditrytus$elmtris$View$showLevelBox(_p9),
										_1: {
											ctor: '::',
											_0: _ditrytus$elmtris$View$showLinesBox(_p9),
											_1: {ctor: '[]'}
										}
									}
								}
			...
			return _elm_lang$core$List$concat(
				{
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _ditrytus$elmtris$View$showPointsBox(_p10),
							_1: {
								ctor: '::',
								_0: _ditrytus$elmtris$View$showLevelBox(_p10),
								_1: {
									ctor: '::',
									_0: _ditrytus$elmtris$View$showLinesBox(_p10),
									_1: {
										ctor: '::',
										_0: _ditrytus$elmtris$View$textInTheBoard(
											_ditrytus$elmtris$View$appendInstructions(
												{
													ctor: '::',
													_0: 'Paused',
			...
			return _elm_lang$core$List$concat(
				{
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _ditrytus$elmtris$View$showPointsBox(_p11),
							_1: {
								ctor: '::',
								_0: _ditrytus$elmtris$View$showLevelBox(_p11),
								_1: {
									ctor: '::',
									_0: _ditrytus$elmtris$View$showLinesBox(_p11),
									_1: {
										ctor: '::',
										_0: _ditrytus$elmtris$View$textInTheBoard(
											_ditrytus$elmtris$View$appendInstructions(
		...
		_elm_lang$svg$Svg$svg,
		{
			...
			_0: _elm_lang$svg$Svg_Attributes$viewBox(
				A2(
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						_elm_lang$core$Basics$toString(_ditrytus$elmtris$View$displaySize.width),
						A2(
							_elm_lang$core$Basics_ops['++'],
							' ',
							_elm_lang$core$Basics$toString(_ditrytus$elmtris$View$displaySize.height))))),
			_1: {
				ctor: '::',
...
var _ditrytus$elmtris$Main$main = _elm_lang$html$Html$program(
	{init: _ditrytus$elmtris$Model$init, view: _ditrytus$elmtris$View$view, update: _ditrytus$elmtris$Update$update, subscriptions: _ditrytus$elmtris$Subscriptions$subscriptions})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _ditrytus$elmtris$Main$main !== 'undefined') {
    _ditrytus$elmtris$Main$main(Elm['Main'], 'Main', undefined);
}
